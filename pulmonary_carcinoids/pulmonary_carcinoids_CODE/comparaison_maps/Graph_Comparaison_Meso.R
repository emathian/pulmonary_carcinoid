...
ku_stack =c(6,20,30,50,100, 110 ,  120, 130  ,150, 180 ,200,250)
plot_set_diff(Set_diff, TM_coords ,ku_stack)
ku_stack =c(6,20,30,50,100, 110  , 120 , 130 ,150, 180 ,200,250)
plot_seq_diff(Seq_diff, TM_coords ,ku_stack)
CP_all <- read.table("CP_MesosomicsV2.txt", sep = "\t", dec="." , header = TRUE,   quote="")
ku_stack = unique(CP_all$K) ; ku_stack
plot_centrality_preservation(CP_all, TM_coords, ku_stack  , "2")
ku_stack = unique(CP_all$K) ; ku_stack
plot_centrality_preservation(CP_all, TM_coords, ku_stack  , "N")
