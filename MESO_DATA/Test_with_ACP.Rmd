...
```{r eval=TRUE, echo=TRUE}
IHC_moy_df <- data.frame(Sample =uniq_tot_sample  ,  VEGFR2 = rep(0,length(uniq_tot_sample)), VEGFR3M = rep(0,length(uniq_tot_sample)), PDL1_p = rep(0,length(uniq_tot_sample)), CD8_p = rep(0,length(uniq_tot_sample)), VISTA = rep(0,length(uniq_tot_sample)))
