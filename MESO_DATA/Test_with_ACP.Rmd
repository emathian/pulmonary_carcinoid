...
replication_acp = data.frame(Vista_r, Vegfr2_r_mb ,Vegfr2_r.f ,   Vegfr3_r.f , CD8_r,  PDL1.TILS_r.f) #PDL1_r,Vegfr3_r_cyto.f
...
plot(Attributes_replication$Axis1, Attributes_replication$Axis2 , col = as.factor(Attributes_replication$GRP))
```
